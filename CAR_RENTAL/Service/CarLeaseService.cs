...
namespace CAR_RENTAL_SYSTEM.Service
{
    ...
    {
        private readonly CarLeaseRepository _carLeaseRepository;

        public CarLeaseService(CarLeaseRepository carLeaseRepository)
        {
        ...
        public void RemoveVehicle()
        {
            try
            {
                ...
                string vehicleId = Console.ReadLine();
                Vehicle vehicle = _carLeaseRepository.GetVehicleById(vehicleId);
        ...
        public void RemoveCustomer()
        {
            try
            {
                ...
                Customer customer = _carLeaseRepository.GetCustomerById(customerID);
                if (customer != null)
                {
        ...
        public void CreateLease()
        {
            try
            {
                ...
                Console.Write("Enter Vehicle ID: ");
                string vehicleId = Console.ReadLine();
                Console.WriteLine("DailyLease/MonthlyLease: ");
                ...
                Lease lease = _carLeaseRepository.createLease(customerId, vehicleId, startDate, endDate, leaseType);
        ...
        public void ViewLeaseById()
        {
            try
            {
                ...
                Lease lease = _carLeaseRepository.ViewLeaseById(leaseId);
                ...
                if (lease != null)
                {
                    ...
                    Console.WriteLine($"Start Date: {lease.StartDate:yyyy-MM-dd}");
                    Console.WriteLine($"End Date: {lease.EndDate:yyyy-MM-dd}");
                    Console.WriteLine($"Lease Type: {lease.LeaseType}");
